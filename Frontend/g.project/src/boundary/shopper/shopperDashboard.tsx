...
export function AddStore({instance, andRefreshDisplay, loginToken}: {instance: any, andRefreshDisplay: any, loginToken: any}){
  ...
  return(
    <div>
      <b>Chain Name: </b><input id="store-chain-to-add" placeholder="Chain Name" data-testid="store-chain-to-add"></input><br></br>
      <b>Store Name: </b><input id="store-name-to-add" placeholder="Store Name" data-testid="store-name-to-add"></input><br></br>
      <b>Store Address: </b><input id="store-address-to-add" placeholder="Store Address" data-testid="store-address-to-add"></input><br></br>
...
export function AddChain({instance, andRefreshDisplay, loginToken}: {instance: any, andRefreshDisplay: any, loginToken: any}){
  ...
  return(
    <div>
      <b>Chain Name: </b><input id="chain-name-to-add" placeholder="Chain Name" data-testid="chain-name-to-add"></input><br></br>
      <b>Chain Url: </b><input id="chain-url-to-add" placeholder="Chain Url" data-testid="chain-url-to-add"></input><br></br>
